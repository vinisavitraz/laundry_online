...
public class ReceiptsReportResponseDto {
    private List<ReportColumn> header;
    private List<ReportRow> content;

    public ReceiptsReportResponseDto(List<ReportColumn> header, List<ReportRow> content) {
        this.header = header;
        this.content = content;
    }

    public ReceiptsReportResponseDto() {
    }
